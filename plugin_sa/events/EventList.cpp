...
CdeclEvent    <AddressList<0x58AA2D, H_JUMP, 0x575B44, H_CALL>, PR_AFT, ArgPickNone, void()>     plugin::Events::drawBlipsEvent;
CdeclEvent    <AddressList<0x5759E4, H_CALL, 0x5869BF, H_CALL>, PR_AFT, ArgPickNone, void(bool)> plugin::Events::drawRadarOverlayEvent;
...
CdeclEvent    <AddressList<0x748CFB, H_CALL>, PR_AFT, ArgPickNone,            void()>            plugin::Events::initGameEvent;
CdeclEvent    <AddressList<0x748E09, H_CALL,
                           0x748E48, H_CALL>, PR_AFT, ArgPickNone,            void()>            plugin::Events::reInitGameEvent;