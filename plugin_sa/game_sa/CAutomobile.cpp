...
// Converted from thiscall void CAutomobile::DoNitroEffect(float state) 0x6A3BD0
void CAutomobile::DoNitroEffect(float state)
{
    ((void(__thiscall *)(CAutomobile*, float))0x6A3BD0)(this, state);
}
