...
#pragma pack(pop)
    ...
    unsigned short Say(unsigned short gCtx, unsigned int startTimeDelay = 0, float probability = 1.0f, bool overrideSilence = false, bool isForceAudible = false, bool isFrontEnd = false);
...
VALIDATE_OFFSET(CPed, m_pedAudio, 0x138);
VALIDATE_OFFSET(CPed, m_pedSpeech, 0x294);
VALIDATE_OFFSET(CPed, m_weaponAudio, 0x394);
VALIDATE_OFFSET(CPed, field_43C, 0x43C);
VALIDATE_OFFSET(CPed, m_roadRageWith, 0x460);
VALIDATE_OFFSET(CPed, field_464, 0x464);
VALIDATE_OFFSET(CPed, field_468, 0x468);
VALIDATE_OFFSET(CPed, m_pIntelligence, 0x47C);
VALIDATE_OFFSET(CPed, m_pPlayerData, 0x480);
VALIDATE_OFFSET(CPed, m_nCreatedBy, 0x484);
VALIDATE_OFFSET(CPed, field_485, 0x485);
VALIDATE_OFFSET(CPed, m_apBones, 0x488);
VALIDATE_OFFSET(CPed, m_nAnimGroup, 0x4D4);
VALIDATE_OFFSET(CPed, m_vecAnimMovingShiftLocal, 0x4D8);
VALIDATE_OFFSET(CPed, m_acquaintance, 0x4E0);
VALIDATE_OFFSET(CPed, m_pWeaponObject, 0x4F4);
VALIDATE_OFFSET(CPed, m_pGunflashObject, 0x4F8);
VALIDATE_OFFSET(CPed, m_pGogglesObject, 0x4FC);
VALIDATE_OFFSET(CPed, m_pGogglesState, 0x500);
VALIDATE_OFFSET(CPed, m_nWeaponGunflashAlphaMP1, 0x504);
VALIDATE_OFFSET(CPed, m_nWeaponGunFlashAlphaProgMP1, 0x506);
VALIDATE_OFFSET(CPed, m_nWeaponGunflashAlphaMP2, 0x508);
VALIDATE_OFFSET(CPed, m_nWeaponGunFlashAlphaProgMP2, 0x50A);
VALIDATE_OFFSET(CPed, m_pedIK, 0x50C);
VALIDATE_OFFSET(CPed, m_nAntiSpazTimer, 0x52C);
VALIDATE_OFFSET(CPed, m_ePedState, 0x530);
VALIDATE_OFFSET(CPed, m_nMoveState, 0x534);
VALIDATE_OFFSET(CPed, m_nSwimmingMoveState, 0x538);
VALIDATE_OFFSET(CPed, field_53C, 0x53C);
VALIDATE_OFFSET(CPed, m_fHealth, 0x540);
VALIDATE_OFFSET(CPed, m_fMaxHealth, 0x544);
VALIDATE_OFFSET(CPed, m_fArmour, 0x548);
VALIDATE_OFFSET(CPed, m_nTimeTillWeNeedThisPed, 0x54C);
VALIDATE_OFFSET(CPed, m_vecAnimMovingShift, 0x550);
VALIDATE_OFFSET(CPed, m_fHeadingCurrent, 0x558);
VALIDATE_OFFSET(CPed, m_fHeadingGoal, 0x55C);
VALIDATE_OFFSET(CPed, m_fHeadingChangeRate, 0x560);
VALIDATE_OFFSET(CPed, m_fMoveAnim, 0x564);
VALIDATE_OFFSET(CPed, m_standingOnEntity, 0x568);
VALIDATE_OFFSET(CPed, field_56C, 0x56C);
VALIDATE_OFFSET(CPed, field_578, 0x578);
VALIDATE_OFFSET(CPed, m_pContactEntity, 0x584);
VALIDATE_OFFSET(CPed, field_588, 0x588);
VALIDATE_OFFSET(CPed, m_pVehicle, 0x58C);
VALIDATE_OFFSET(CPed, m_VehDeadInFrontOf, 0x590);
VALIDATE_OFFSET(CPed, field_594, 0x594);
VALIDATE_OFFSET(CPed, m_nPedType, 0x598);
VALIDATE_OFFSET(CPed, m_pStats, 0x59C);
VALIDATE_OFFSET(CPed, m_aWeapons, 0x5A0);
VALIDATE_OFFSET(CPed, m_nSavedWeapon, 0x70C);
VALIDATE_OFFSET(CPed, m_nDelayedWeapon, 0x710);
VALIDATE_OFFSET(CPed, m_nDelayedWeaponAmmo, 0x714);
VALIDATE_OFFSET(CPed, m_nSelectedWepSlot, 0x718);
VALIDATE_OFFSET(CPed, m_nWeaponShootingRate, 0x719);
VALIDATE_OFFSET(CPed, m_nWeaponAccuracy, 0x71A);
VALIDATE_OFFSET(CPed, m_pTargetedObject, 0x71C);
VALIDATE_OFFSET(CPed, field_720, 0x720);
VALIDATE_OFFSET(CPed, field_724, 0x724);
VALIDATE_OFFSET(CPed, field_728, 0x728);
VALIDATE_OFFSET(CPed, m_nWeaponSkill, 0x72C);
VALIDATE_OFFSET(CPed, m_nFightingStyle, 0x72D);
VALIDATE_OFFSET(CPed, m_nAllowedAttackMoves, 0x72E);
VALIDATE_OFFSET(CPed, field_72F, 0x72F);
VALIDATE_OFFSET(CPed, m_pFire, 0x730);
VALIDATE_OFFSET(CPed, m_fireDmgMult, 0x734);
VALIDATE_OFFSET(CPed, m_pLookTarget, 0x738);
VALIDATE_OFFSET(CPed, m_fLookDirection, 0x73C);
VALIDATE_OFFSET(CPed, m_nWeaponModelId, 0x740);
VALIDATE_OFFSET(CPed, m_nUnconsciousTimer, 0x744);
VALIDATE_OFFSET(CPed, m_nLookTime, 0x748);
VALIDATE_OFFSET(CPed, m_nAttackTimer, 0x74C);
VALIDATE_OFFSET(CPed, m_nDeathTime, 0x750);
VALIDATE_OFFSET(CPed, m_nBodypartToRemove, 0x754);
VALIDATE_OFFSET(CPed, field_755, 0x755);
VALIDATE_OFFSET(CPed, m_nMoneyCount, 0x756);
VALIDATE_OFFSET(CPed, m_Wobble, 0x758);
VALIDATE_OFFSET(CPed, m_WobbleSpeed, 0x75C);
VALIDATE_OFFSET(CPed, m_nLastWeaponDamage, 0x760);
VALIDATE_OFFSET(CPed, m_pLastEntityDamage, 0x764);
VALIDATE_OFFSET(CPed, field_768, 0x768);
VALIDATE_OFFSET(CPed, m_vecTurretOffset, 0x76C);
VALIDATE_OFFSET(CPed, m_fTurretAngleA, 0x778);
VALIDATE_OFFSET(CPed, m_fTurretAngleB, 0x77C);
VALIDATE_OFFSET(CPed, m_nTurretPosnMode, 0x780);
VALIDATE_OFFSET(CPed, m_nTurretAmmo, 0x784);
VALIDATE_OFFSET(CPed, m_pCoverPoint, 0x788);
VALIDATE_OFFSET(CPed, m_pEnex, 0x78C);
VALIDATE_OFFSET(CPed, m_fRemovalDistMultiplier, 0x790);
VALIDATE_OFFSET(CPed, m_StreamedScriptBrainToLoad, 0x794);
VALIDATE_OFFSET(CPed, field_796, 0x796);
VALIDATE_OFFSET(CPed, field_798, 0x798);
