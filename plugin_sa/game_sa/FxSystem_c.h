...
VALIDATE_OFFSET(FxSystem_c, m_pBlueprint, 0x8);
VALIDATE_OFFSET(FxSystem_c, m_pParentMatrix, 0xC);
VALIDATE_OFFSET(FxSystem_c, m_localMatrix, 0x10);
VALIDATE_OFFSET(FxSystem_c, m_nPlayStatus, 0x50);
VALIDATE_OFFSET(FxSystem_c, m_nKillStatus, 0x51);
VALIDATE_OFFSET(FxSystem_c, m_bConstTimeSet, 0x52);
VALIDATE_OFFSET(FxSystem_c, field_53, 0x53);
VALIDATE_OFFSET(FxSystem_c, field_54, 0x54);
VALIDATE_OFFSET(FxSystem_c, m_fCameraDistance, 0x58);
VALIDATE_OFFSET(FxSystem_c, m_nConstTime, 0x5C);
VALIDATE_OFFSET(FxSystem_c, m_nRateMult, 0x5E);
VALIDATE_OFFSET(FxSystem_c, m_nTimeMult, 0x60);
VALIDATE_OFFSET(FxSystem_c, m_nFlags, 0x62);
VALIDATE_OFFSET(FxSystem_c, field_63, 0x63);
VALIDATE_OFFSET(FxSystem_c, fUnkRandom, 0x64);
VALIDATE_OFFSET(FxSystem_c, m_vecVelAdd, 0x68);
VALIDATE_OFFSET(FxSystem_c, m_pBounding, 0x74);
VALIDATE_OFFSET(FxSystem_c, m_pPrimsPtrList, 0x78);
VALIDATE_OFFSET(FxSystem_c, m_fireAudio, 0x7C);
VALIDATE_SIZE(FxSystem_c, 0x104);
