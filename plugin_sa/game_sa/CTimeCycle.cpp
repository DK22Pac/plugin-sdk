...
unsigned __int8* CTimeCycle::m_nDirectionalMult{ (unsigned __int8*)0xB79FD8 };		 //m_nDirectionalMult[184]
			
unsigned __int8* CTimeCycle::m_nWaterFogAlpha{ (unsigned __int8*)0xB7A090 };			 //m_nWaterFogAlpha[184]
			
unsigned __int8* CTimeCycle::m_nHighLightMinIntensity{ (unsigned __int8*)0xB7A148 };   //m_nHighLightMinIntensity[184]
			
unsigned __int8* CTimeCycle::m_fCloudAlpha{ (unsigned __int8*)0xB7A200 };              //m_fCloudAlpha[184]
			
unsigned __int8* CTimeCycle::m_fPostFx2Alpha{ (unsigned __int8*)0xB7A2B8 };            //m_fPostFx2Alpha[184]
			
unsigned __int8* CTimeCycle::m_fPostFx2Blue{ (unsigned __int8*)0xB7A370 };             //m_fPostFx2Blue[184]
			
unsigned __int8* CTimeCycle::m_fPostFx2Green{ (unsigned __int8*)0xB7A428 };            //m_fPostFx2Green[184]
			
unsigned __int8* CTimeCycle::m_fPostFx2Red{ (unsigned __int8*)0xB7A4E0 };              //m_fPostFx2Red[184]
				
unsigned __int8* CTimeCycle::m_fPostFx1Alpha{ (unsigned __int8*)0xB7A598 };            //m_fPostFx1Alpha[184]
				
unsigned __int8* CTimeCycle::m_fPostFx1Blue{ (unsigned __int8*)0xB7A650 };             //m_fPostFx1Blue[184]
			
unsigned __int8* CTimeCycle::m_fPostFx1Green{ (unsigned __int8*)0xB7A708 };            //m_fPostFx1Green[184]
			
unsigned __int8* CTimeCycle::m_fPostFx1Red{ (unsigned __int8*)0xB7A7C0 };              //m_fPostFx1Red[184]
			
unsigned __int8* CTimeCycle::m_fWaterAlpha{ (unsigned __int8*)0xB7A878 };              //m_fWaterAlpha[184]
			
unsigned __int8* CTimeCycle::m_fWaterBlue{ (unsigned __int8*)0xB7A930 };               //m_fWaterBlue[184]
				
unsigned __int8* CTimeCycle::m_fWaterGreen{ (unsigned __int8*)0xB7A9E8 };              //m_fWaterGreen[184]
				
unsigned __int8* CTimeCycle::m_fWaterRed{ (unsigned __int8*)0xB7AAA0 };                //m_fWaterRed[184]
				 
unsigned __int8* CTimeCycle::m_nFluffyCloudsBottomBlue{ (unsigned __int8*)0xB7AB58 };  //m_nFluffyCloudsBottomBlue[184]
				
unsigned __int8* CTimeCycle::m_nFluffyCloudsBottomGreen{ (unsigned __int8*)0xB7AC10 }; //m_nFluffyCloudsBottomGreen[184]
				 
unsigned __int8* CTimeCycle::m_nFluffyCloudsBottomRed{ (unsigned __int8*)0xB7ACC8 };   //m_nFluffyCloudsBottomRed[184]
				
unsigned __int8* CTimeCycle::m_nLowCloudsBlue{ (unsigned __int8*)0xB7AD80 };           //m_nLowCloudsBlue[184]
			
unsigned __int8* CTimeCycle::m_nLowCloudsGreen{ (unsigned __int8*)0xB7AE38 };          //m_nLowCloudsGreen[184]
				
unsigned __int8* CTimeCycle::m_nLowCloudsRed{ (unsigned __int8*)0xB7AEF0 };            //m_nLowCloudsRed[184]

unsigned __int8* CTimeCycle::m_fLightsOnGroundBrightness{ (unsigned __int8*)0xB7AFA8 }; //m_fLightsOnGroundBrightness[184]

signed __int16* CTimeCycle::m_fFogStart{ (signed __int16*)0xB7B060 };                 //m_fFogStart[184]

signed __int16* CTimeCycle::m_fFarClip{ (signed __int16*)0xB7B1D0 };                  //m_fFarClip[184]

unsigned __int8* CTimeCycle::m_nPoleShadowStrength{ (unsigned __int8*)0xB7B340 };      //m_nPoleShadowStrength[184]

unsigned __int8* CTimeCycle::m_nLightShadowStrength{ (unsigned __int8*)0xB7B3F8 };     //m_nLightShadowStrength[184]

unsigned __int8* CTimeCycle::m_nShadowStrength{ (unsigned __int8*)0xB7B4B0 };          //m_nShadowStrength[184]
...
unsigned __int8* CTimeCycle::m_nSunCoronaBlue{ (unsigned __int8*)0xB7B790 };          //m_nSunCoronaBlue[184]

unsigned __int8* CTimeCycle::m_nSunCoronaGreen{ (unsigned __int8*)0xB7B848 };         //m_nSunCoronaGreen[184]

unsigned __int8* CTimeCycle::m_nSunCoronaRed{ (unsigned __int8*)0xB7B900 };           //m_nSunCoronaRed[184]

unsigned __int8* CTimeCycle::m_nSunCoreBlue{ (unsigned __int8*)0xB7B9B8 };           //m_nSunCoreBlue[184]

unsigned __int8* CTimeCycle::m_nSunCoreGreen{ (unsigned __int8*)0xB7BA70 };          //m_nSunCoreGreen[184]

unsigned __int8* CTimeCycle::m_nSunCoreRed{ (unsigned __int8*)0xB7BB28 };            //m_nSunCoreRed[184]

unsigned __int8* CTimeCycle::m_nSkyBottomBlue{ (unsigned __int8*)0xB7BBE0 };         //m_nSkyBottomBlue[184]

unsigned __int8* CTimeCycle::m_nSkyBottomGreen{ (unsigned __int8*)0xB7BC98 };        //m_nSkyBottomGreen[184]

unsigned __int8* CTimeCycle::m_nSkyBottomRed{ (unsigned __int8*)0xB7BD50 };         //m_nSkyBottomRed[184]

unsigned __int8* CTimeCycle::m_nSkyTopBlue{ (unsigned __int8*)0xB7BE08 };            //m_nSkyTopBlue[45]

unsigned __int8* CTimeCycle::m_nSkyTopGreen{ (unsigned __int8*)0xB7BEC0 };           //m_nSkyTopGreen[45]

unsigned __int8* CTimeCycle::m_nSkyTopRed{ (unsigned __int8*)0xB7BF78 };             //m_nSkyTopRed[45]

unsigned __int8* CTimeCycle::m_nAmbientBlue_Obj{ (unsigned __int8*)0xB7C030 };      //m_nAmbientBlue_Obj[184]

unsigned __int8* CTimeCycle::m_nAmbientGreen_Obj{ (unsigned __int8*)0xB7C0E8 };     //m_nAmbientGreen_Obj[184]

unsigned __int8* CTimeCycle::m_nAmbientRed_Obj{ (unsigned __int8*)0xB7C1A0 };       //m_nAmbientRed_Obj[184]

unsigned __int8* CTimeCycle::m_nAmbientBlue{ (unsigned __int8*)0xB7C258 };          //m_nAmbientBlue[184]

unsigned __int8* CTimeCycle::m_nAmbientGreen{ (unsigned __int8*)0xB7C310 };         //m_nAmbientGreen[184]

unsigned __int8* CTimeCycle::m_nAmbientRed{ (unsigned __int8*)0xB7C3C8 };           //m_nAmbientRed[184]
...
void CTimeCycle::FindFarClipForCoors(CVector cam_pos) {
