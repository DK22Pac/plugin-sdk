...
VALIDATE_OFFSET(CVehicle, m_nHandlingFlagsIntValue, 0x38C);
...
VALIDATE_OFFSET(CVehicle, m_nForcedRandomRouteSeed, 0x45E);
...
VALIDATE_OFFSET(CVehicle, m_pEntityWeAreOn, 0x48C);
...
VALIDATE_OFFSET(CVehicle, m_nUsedForCover, 0x4AA);
VALIDATE_OFFSET(CVehicle, m_nAmmoInClip, 0x4AB);
VALIDATE_OFFSET(CVehicle, m_nPacMansCollected, 0x4AC);
VALIDATE_OFFSET(CVehicle, m_nPedsPositionForRoadBlock, 0x4AD);
...
VALIDATE_OFFSET(CVehicle, m_fGearChangeCount, 0x4B8);
...
VALIDATE_OFFSET(CVehicle, m_pWhoInstalledBombOnMe, 0x4CC);
VALIDATE_OFFSET(CVehicle, m_nTimeTillWeNeedThisCar, 0x4D0);
VALIDATE_OFFSET(CVehicle, m_nGunFiringTime, 0x4D4);
VALIDATE_OFFSET(CVehicle, m_nTimeWhenBlowedUp, 0x4D8);
VALIDATE_OFFSET(CVehicle, m_nCopsInCarTimer, 0x4DC);
VALIDATE_OFFSET(CVehicle, m_wBombTimer, 0x4DE);
VALIDATE_OFFSET(CVehicle, m_pWhoDetonatedMe, 0x4E0);
VALIDATE_OFFSET(CVehicle, m_fVehicleFrontGroundZ, 0x4E4);
VALIDATE_OFFSET(CVehicle, m_fVehicleRearGroundZ, 0x4E8);
VALIDATE_OFFSET(CVehicle, field_4EC, 0x4EC);
VALIDATE_OFFSET(CVehicle, field_4ED, 0x4ED);
...
VALIDATE_OFFSET(CVehicle, m_nLastWeaponDamageType, 0x508);
VALIDATE_OFFSET(CVehicle, m_pLastDamageEntity, 0x50C);
VALIDATE_OFFSET(CVehicle, field_510, 0x510);
VALIDATE_OFFSET(CVehicle, field_511, 0x511);
VALIDATE_OFFSET(CVehicle, field_512, 0x512);
VALIDATE_OFFSET(CVehicle, m_nVehicleWeaponInUse, 0x513);
VALIDATE_OFFSET(CVehicle, m_nHornCounter, 0x514);
VALIDATE_OFFSET(CVehicle, m_HornPattern, 0x518);
VALIDATE_OFFSET(CVehicle, m_nCarHornTimer, 0x519);
...
VALIDATE_OFFSET(CVehicle, m_anCollisionLighting, 0x574);
...
VALIDATE_OFFSET(CVehicle, m_renderLights, 0x584);
VALIDATE_OFFSET(CVehicle, m_pCustomCarPlate, 0x588);
VALIDATE_OFFSET(CVehicle, m_fRawSteerAngle, 0x58C);
