...
VALIDATE_OFFSET(CBike, m_aBikeNodes, 0x5A0);
VALIDATE_OFFSET(CBike, m_bLeanMatrixCalculated, 0x5C8);
VALIDATE_OFFSET(CBike, m_mLeanMatrix, 0x5CC);
VALIDATE_OFFSET(CBike, m_nBikeFlags, 0x614);
VALIDATE_OFFSET(CBike, m_vecAveGroundNormal, 0x618);
VALIDATE_OFFSET(CBike, m_vecGroundRight, 0x624);
VALIDATE_OFFSET(CBike, m_vecOldSpeedForPlayback, 0x630);
VALIDATE_OFFSET(CBike, m_pBikeHandlingData, 0x63C);
VALIDATE_OFFSET(CBike, m_rideAnimData, 0x640);
VALIDATE_OFFSET(CBike, m_nWheelStatus, 0x65C);
VALIDATE_OFFSET(CBike, m_anWheelColPoint, 0x660);
VALIDATE_OFFSET(CBike, m_aWheelRatios, 0x710);
VALIDATE_OFFSET(CBike, m_aRatioHistory, 0x720);
VALIDATE_OFFSET(CBike, m_fWheelCounts, 0x730);
VALIDATE_OFFSET(CBike, m_fBrakeCount, 0x740);
VALIDATE_OFFSET(CBike, m_aWheelSkidmarkType, 0x744);
VALIDATE_OFFSET(CBike, m_bWheelBloody, 0x74C);
VALIDATE_OFFSET(CBike, m_bMoreSkidMarks, 0x74E);
VALIDATE_OFFSET(CBike, m_aWheelPitchAngles, 0x750);
VALIDATE_OFFSET(CBike, m_aWheelAngularVelocity, 0x758);
VALIDATE_OFFSET(CBike, m_aWheelSuspensionHeights, 0x760);
VALIDATE_OFFSET(CBike, m_aWheelOrigHeights, 0x768);
VALIDATE_OFFSET(CBike, m_fSuspensionLength, 0x770);
VALIDATE_OFFSET(CBike, m_fLineLength, 0x780);
VALIDATE_OFFSET(CBike, m_fHeightAboveRoad, 0x790);
VALIDATE_OFFSET(CBike, m_fExtraTractionMult, 0x794);
VALIDATE_OFFSET(CBike, m_fSwingArmLength, 0x798);
VALIDATE_OFFSET(CBike, m_fForkYOffset, 0x79C);
VALIDATE_OFFSET(CBike, m_fForkZOffset, 0x7A0);
VALIDATE_OFFSET(CBike, m_fSteerAngleTan, 0x7A4);
VALIDATE_OFFSET(CBike, m_nBrakesOn, 0x7A8);
VALIDATE_OFFSET(CBike, m_fNitroValue, 0x7AC);
VALIDATE_OFFSET(CBike, m_fBrakingSlide, 0x7B0);
VALIDATE_OFFSET(CBike, m_nFixLeftHand, 0x7B4);
VALIDATE_OFFSET(CBike, m_nFixRightHand, 0x7B5);
VALIDATE_OFFSET(CBike, m_nTestPedCollision, 0x7B6);
VALIDATE_OFFSET(CBike, m_fPrevSpeed, 0x7B8);
VALIDATE_OFFSET(CBike, m_fBurningTimer, 0x7BC);
VALIDATE_OFFSET(CBike, m_apWheelCollisionEntity, 0x7C0);
VALIDATE_OFFSET(CBike, m_avTouchPointsLocalSpace, 0x7D0);
VALIDATE_OFFSET(CBike, m_pDamager, 0x800);
VALIDATE_OFFSET(CBike, m_nNumContactWheels, 0x804);
VALIDATE_OFFSET(CBike, m_nNumWheelsOnGround, 0x805);
VALIDATE_OFFSET(CBike, m_nNumDriveWheelsOnGroundLastFrame, 0x806);
