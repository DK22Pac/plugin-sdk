...
PLUGIN_VARIABLE bool const &CTheScripts::DbgFlag = *reinterpret_cast<bool const *>(GLOBAL_ADDRESS_BY_VERSION(0x859CF8, 0, 0, 0, 0, 0));
...
PLUGIN_VARIABLE tScriptVarValue *CTheScripts::LocalVariablesForCurrentMission = reinterpret_cast<tScriptVarValue *>(GLOBAL_ADDRESS_BY_VERSION(0xA48960, 0, 0, 0, 0, 0));
