...
// Converted from thiscall void Fx_c::Fx_c(void) 0x49E620
Fx_c::Fx_c() {
    ((void(__thiscall *)(Fx_c*))0x49E620)(this);
}

// Converted from thiscall void Fx_c::~Fx_c() 0x49E630
Fx_c::~Fx_c() {
    ((void(__thiscall *)(Fx_c*))0x49E630)(this);
}

// Converted from thiscall void Fx_c::Update(RwCamera *camera, float timeDelta) 0x49E640
...
// Converted from thiscall void Fx_c::InitStaticSystems(void) 0x49E660
void Fx_c::InitStaticSystems() {
    ((void(__thiscall *)(Fx_c*))0x49E660)(this);
}

// Converted from thiscall void Fx_c::ExitStaticSystems(void) 0x49E850
...
// Converted from thiscall int Fx_c::GetFxQuality(void) 0x49EA50
FxQuality_e Fx_c::GetFxQuality() {
    return ((FxQuality_e (__thiscall *)(Fx_c*))0x49EA50)(this);
}

// Converted from thiscall void Fx_c::InitEntitySystems(void) 0x49EA60
void Fx_c::InitEntitySystems() {
    ((void(__thiscall *)(Fx_c*))0x49EA60)(this);
}

// Converted from thiscall bool Fx_c::Init(void) 0x49EA90
bool Fx_c::Init() {
    return ((bool(__thiscall *)(Fx_c*))0x49EA90)(this);
}

// Converted from thiscall void Fx_c::Reset(void) 0x49EAE0
void Fx_c::Reset() {
    ((void(__thiscall *)(Fx_c*))0x49EAE0)(this);
}

// Converted from thiscall void Fx_c::AddBlood(CVector &origin, CVector &direction, int amount, float) 0x49EB00
...
// Converted from thiscall void Fx_c::AddWood(CVector &origin, CVector &direction, int amount, float) 0x49EE10
...
// Converted from thiscall void Fx_c::AddTyreBurst(CVector &position,CVector &velocity) 0x49F300
...
// Converted from thiscall void Fx_c::AddBulletImpact(CVector &position,CVector &direction,int bulletFxType,int amount,float) 0x49F3D0
...
// Converted from thiscall void Fx_c::AddPunchImpact(CVector &position,CVector &velocity,int) 0x49F670
...
// Converted from thiscall void Fx_c::AddDebris(CVector &position,RwRGBA &color,float scale,int amount) 0x49F750
...
// Converted from thiscall void Fx_c::AddGlass(CVector &position,RwRGBA &color,float scale,int amount) 0x49F970
...
// Converted from thiscall void Fx_c::TriggerWaterHydrant(CVector &position) 0x4A0D70
void Fx_c::TriggerWaterHydrant(CVector& position) {
    ((void(__thiscall *)(Fx_c*, CVector&))0x4A0D70)(this, position);
}

// Converted from thiscall void Fx_c::TriggerGunshot(CEntity *entity,CVector &origin,CVector &target,bool doGunflash) 0x4A0DE0
...
// Converted from thiscall void Fx_c::TriggerTankFire(CVector &origin,CVector &target) 0x4A0FA0
void Fx_c::TriggerTankFire(CVector& origin, CVector& target) {
    ((void(__thiscall *)(Fx_c*, CVector&, CVector&))0x4A0FA0)(this, origin, target);
}

// Converted from thiscall void Fx_c::TriggerWaterSplash(CVector &position) 0x4A1070
void Fx_c::TriggerWaterSplash(CVector& position) {
    ((void(__thiscall *)(Fx_c*, CVector&))0x4A1070)(this, position);
}

// Converted from thiscall void Fx_c::TriggerBulletSplash(CVector &position) 0x4A10E0
void Fx_c::TriggerBulletSplash(CVector& position) {
    ((void(__thiscall *)(Fx_c*, CVector&))0x4A10E0)(this, position);
}

// Converted from thiscall void Fx_c::TriggerFootSplash(CVector &position) 0x4A1150
void Fx_c::TriggerFootSplash(CVector& position) {
    ((void(__thiscall *)(Fx_c*, CVector&))0x4A1150)(this, position);
}

// Converted from thiscall void Fx_c::CreateEntityFx(CEntity *entity,char *fxName,RwV3d *position,RwMatrix *transform) 0x4A11E0
...
// Converted from thiscall void Fx_c::DestroyEntityFx(CEntity *entity) 0x4A1280
void Fx_c::DestroyEntityFx(CEntity* entity) {
    ((void(__thiscall *)(Fx_c*, CEntity*))0x4A1280)(this, entity);
}

// Converted from thiscall void Fx_c::ExitEntitySystems(void) 0x4A12D0
void Fx_c::ExitEntitySystems() {
    ((void(__thiscall *)(Fx_c*))0x4A12D0)(this);
}

// Converted from thiscall void Fx_c::Exit(void) 0x4A1320
void Fx_c::Exit() {
...
// Converted from cdecl void RenderAddTri(float x1,float y1,float z1,float x2,float y2,float z2,float x3,float y3,float z3,float u1,float v1,float u2,float v2,float u3,float v3,int r1,int g1,int b1,int a1,int r2,int g2,int b2,int a2,int r3,int g3,int b3,int a3) 0x4A1410
...
// Converted from cdecl void RenderEnd(void) 0x4A1600
void RenderEnd() {
    ((void(__cdecl *)())0x4A1600)();
}

// Converted from cdecl void RotateVecIntoVec(RwV3d *vectorsOut,RwV3d *vectorsIn,RwV3d *dir) 0x4A1660
...
// Converted from cdecl void RotateVecAboutVec(RwV3d *out,RwV3d *,RwV3d *,float angle) 0x4A1780
