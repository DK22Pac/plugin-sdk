...
VALIDATE_OFFSET(CPlayerInfo, m_PlayerData, 0x4);
VALIDATE_OFFSET(CPlayerInfo, m_pRemoteVehicle, 0xB0);
VALIDATE_OFFSET(CPlayerInfo, m_pSpecCar, 0xB4);
VALIDATE_OFFSET(CPlayerInfo, m_nMoney, 0xB8);
VALIDATE_OFFSET(CPlayerInfo, m_nDisplayMoney, 0xBC);
VALIDATE_OFFSET(CPlayerInfo, m_nCollectablesPickedUp, 0xC0);
VALIDATE_OFFSET(CPlayerInfo, m_nTotalNumCollectables, 0xC4);
VALIDATE_OFFSET(CPlayerInfo, m_nLastBumpPlayerCarTimer, 0xC8);
VALIDATE_OFFSET(CPlayerInfo, m_nTaxiTimer, 0xCC);
VALIDATE_OFFSET(CPlayerInfo, m_nVehicleTimeCounter, 0xD0);
VALIDATE_OFFSET(CPlayerInfo, m_bTaxiTimerScore, 0xD4);
VALIDATE_OFFSET(CPlayerInfo, m_bTryingToExitCar, 0xD5);
VALIDATE_OFFSET(CPlayerInfo, m_pLastTargetVehicle, 0xD8);
VALIDATE_OFFSET(CPlayerInfo, m_nPlayerState, 0xDC);
VALIDATE_OFFSET(CPlayerInfo, m_bAfterRemoteVehicleExplosion, 0xDD);
VALIDATE_OFFSET(CPlayerInfo, m_bCreateRemoteVehicleExplosion, 0xDE);
VALIDATE_OFFSET(CPlayerInfo, m_bFadeAfterRemoteVehicleExplosion, 0xDF);
VALIDATE_OFFSET(CPlayerInfo, m_nTimeOfRemoteVehicleExplosion, 0xE0);
VALIDATE_OFFSET(CPlayerInfo, m_nLastTimeEnergyLost, 0xE4);
VALIDATE_OFFSET(CPlayerInfo, m_nLastTimeArmourLost, 0xE8);
VALIDATE_OFFSET(CPlayerInfo, m_nLastTimeBigGunFired, 0xEC);
VALIDATE_OFFSET(CPlayerInfo, m_nTimesUpsideDownInARow, 0xF0);
VALIDATE_OFFSET(CPlayerInfo, m_nTimesStuckInARow, 0xF4);
VALIDATE_OFFSET(CPlayerInfo, m_nCarTwoWheelCounter, 0xF8);
VALIDATE_OFFSET(CPlayerInfo, m_fCarTwoWheelDist, 0xFC);
VALIDATE_OFFSET(CPlayerInfo, m_nCarLess3WheelCounter, 0x100);
VALIDATE_OFFSET(CPlayerInfo, m_nBikeRearWheelCounter, 0x104);
VALIDATE_OFFSET(CPlayerInfo, m_fBikeRearWheelDist, 0x108);
VALIDATE_OFFSET(CPlayerInfo, m_nBikeFrontWheelCounter, 0x10C);
VALIDATE_OFFSET(CPlayerInfo, m_fBikeFrontWheelDist, 0x110);
VALIDATE_OFFSET(CPlayerInfo, m_nTempBufferCounter, 0x114);
VALIDATE_OFFSET(CPlayerInfo, m_nBestCarTwoWheelsTimeMs, 0x118);
VALIDATE_OFFSET(CPlayerInfo, m_fBestCarTwoWheelsDistM, 0x11C);
VALIDATE_OFFSET(CPlayerInfo, m_nBestBikeWheelieTimeMs, 0x120);
VALIDATE_OFFSET(CPlayerInfo, m_fBestBikeWheelieDistM, 0x124);
VALIDATE_OFFSET(CPlayerInfo, m_nBestBikeStoppieTimeMs, 0x128);
VALIDATE_OFFSET(CPlayerInfo, m_fBestBikeStoppieDistM, 0x12C);
VALIDATE_OFFSET(CPlayerInfo, m_nCarDensityForCurrentZone, 0x130);
VALIDATE_OFFSET(CPlayerInfo, m_fRoadDensityAroundPlayer, 0x134);
VALIDATE_OFFSET(CPlayerInfo, m_nTimeOfLastCarExplosionCaused, 0x138);
VALIDATE_OFFSET(CPlayerInfo, m_nExplosionMultiplier, 0x13C);
VALIDATE_OFFSET(CPlayerInfo, m_nHavocCaused, 0x140);
VALIDATE_OFFSET(CPlayerInfo, m_nNumHoursDidntEat, 0x144);
VALIDATE_OFFSET(CPlayerInfo, m_fCurrentChaseValue, 0x148);
VALIDATE_OFFSET(CPlayerInfo, m_bDoesNotGetTired, 0x14C);
VALIDATE_OFFSET(CPlayerInfo, m_bFastReload, 0x14D);
VALIDATE_OFFSET(CPlayerInfo, m_bFireProof, 0x14E);
VALIDATE_OFFSET(CPlayerInfo, m_nMaxHealth, 0x14F);
VALIDATE_OFFSET(CPlayerInfo, m_nMaxArmour, 0x150);
VALIDATE_OFFSET(CPlayerInfo, m_bGetOutOfJailFree, 0x151);
VALIDATE_OFFSET(CPlayerInfo, m_bGetOutOfHospitalFree, 0x152);
VALIDATE_OFFSET(CPlayerInfo, m_bCanDoDriveBy, 0x153);
VALIDATE_OFFSET(CPlayerInfo, m_nBustedAudioStatus, 0x154);
VALIDATE_OFFSET(CPlayerInfo, m_nLastBustMessageNumber, 0x156);
VALIDATE_OFFSET(CPlayerInfo, m_nCrosshairActivated, 0x158);
VALIDATE_OFFSET(CPlayerInfo, m_vecCrosshairTarget, 0x15C);
VALIDATE_OFFSET(CPlayerInfo, m_szSkinName, 0x164);
VALIDATE_OFFSET(CPlayerInfo, m_pSkinTexture, 0x184);
VALIDATE_OFFSET(CPlayerInfo, m_bParachuteReferenced, 0x188);
VALIDATE_OFFSET(CPlayerInfo, m_nRequireParachuteTimer, 0x18C);
