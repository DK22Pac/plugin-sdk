...
VALIDATE_OFFSET(CPhysical, field_38, 0x38);
VALIDATE_OFFSET(CPhysical, m_nLastCollisionTime, 0x3C);
VALIDATE_OFFSET(CPhysical, m_vecMoveSpeed, 0x44);
VALIDATE_OFFSET(CPhysical, m_vecTurnSpeed, 0x50);
VALIDATE_OFFSET(CPhysical, m_vecFrictionMoveSpeed, 0x5C);
VALIDATE_OFFSET(CPhysical, m_vecFrictionTurnSpeed, 0x68);
VALIDATE_OFFSET(CPhysical, m_vecForce, 0x74);
VALIDATE_OFFSET(CPhysical, m_vecTorque, 0x80);
VALIDATE_OFFSET(CPhysical, m_fMass, 0x8C);
VALIDATE_OFFSET(CPhysical, m_fTurnMass, 0x90);
VALIDATE_OFFSET(CPhysical, m_fVelocityFrequency, 0x94);
VALIDATE_OFFSET(CPhysical, m_fAirResistance, 0x98);
VALIDATE_OFFSET(CPhysical, m_fElasticity, 0x9C);
VALIDATE_OFFSET(CPhysical, m_fBuoyancyConstant, 0xA0);
VALIDATE_OFFSET(CPhysical, m_vecCentreOfMass, 0xA4);
VALIDATE_OFFSET(CPhysical, m_pCollisionList, 0xB0);
VALIDATE_OFFSET(CPhysical, m_pMovingList, 0xB4);
VALIDATE_OFFSET(CPhysical, m_nFakePhysics, 0xB8);
VALIDATE_OFFSET(CPhysical, m_nNumEntitiesCollided, 0xB9);
VALIDATE_OFFSET(CPhysical, m_nContactSurface, 0xBA);
VALIDATE_OFFSET(CPhysical, field_BB, 0xBB);
VALIDATE_OFFSET(CPhysical, m_apCollidedEntities, 0xBC);
VALIDATE_OFFSET(CPhysical, m_fMovingSpeed, 0xD4);
VALIDATE_OFFSET(CPhysical, m_fDamageIntensity, 0xD8);
VALIDATE_OFFSET(CPhysical, m_pDamageEntity, 0xDC);
VALIDATE_OFFSET(CPhysical, m_vecLastCollisionImpactVelocity, 0xE0);
VALIDATE_OFFSET(CPhysical, m_vecLastCollisionPosn, 0xEC);
VALIDATE_OFFSET(CPhysical, m_nPieceType, 0xF8);
VALIDATE_OFFSET(CPhysical, field_FA, 0xFA);
VALIDATE_OFFSET(CPhysical, m_pAttachedTo, 0xFC);
VALIDATE_OFFSET(CPhysical, m_vecAttachOffset, 0x100);
VALIDATE_OFFSET(CPhysical, m_vecAttachedEntityPosn, 0x10C);
VALIDATE_OFFSET(CPhysical, m_qAttachedEntityRotation, 0x118);
VALIDATE_OFFSET(CPhysical, m_pEntityIgnoredCollision, 0x128);
VALIDATE_OFFSET(CPhysical, m_fContactSurfaceBrightness, 0x12C);
VALIDATE_OFFSET(CPhysical, m_fDynamicLighting, 0x130);
VALIDATE_OFFSET(CPhysical, m_pShadowData, 0x134);
