...
// Converted from thiscall void CStaticShadow::Free(void) 0x707670
void CStaticShadow::Free() {
    ((void(__thiscall *)(CStaticShadow*))0x707670)(this);
}

// Converted from cdecl void CShadows::Init(void) 0x706CD0
void CShadows::Init() {
    ((void(__cdecl *)())0x706CD0)();
}

// Converted from cdecl void CShadows::Shutdown(void) 0x706ED0
...
// Converted from cdecl void CShadows::RemoveOilInArea(float x1,float y1,float x2,float y2) 0x7074F0
...
// Converted from cdecl void CShadows::GunShotSetsOilOnFire(CVector const* shotOrigin,CVector const* shotTarget) 0x707550
...
// Converted from cdecl void CShadows::PrintDebugPoly(CVector *a,CVector *b,CVector *c) 0x7076B0
void CShadows::PrintDebugPoly(CVector* a, CVector* b, CVector* c) {
    ((void(__cdecl *)(CVector*, CVector*, CVector*))0x7076B0)(a, b, c);
}

// Converted from cdecl void CShadows::CalcPedShadowValues(CVector sunPosn,float *displacementX,float *displacementY,float *frontX,float *frontY,float *sideX,float *sideY) 0x7076C0
...
// Converted from cdecl void CShadows::TidyUpShadows(void) 0x707770
...
// Converted from cdecl void CShadows::UpdateStaticShadows(void) 0x707F40
void CShadows::UpdateStaticShadows() {
    ((void(__cdecl *)())0x707F40)();
}

// Converted from cdecl void CShadows::RenderExtraPlayerShadows(void) 0x707FA0
void CShadows::RenderExtraPlayerShadows() {
    ((void(__cdecl *)())0x707FA0)();
}

// Converted from cdecl void CShadows::RenderStaticShadows(void) 0x708300
...
// Converted from cdecl void CShadows::RenderStoredShadows(void) 0x70A960
void CShadows::RenderStoredShadows() {
    ((void(__cdecl *)())0x70A960)();
}

// Converted from cdecl void CShadows::GeneratePolysForStaticShadow(short staticShadowIndex) 0x70B730
...
// Converted from cdecl void CShadows::StoreShadowForVehicle(CVehicle *vehicle,VEH_SHD_TYPE vehShadowType) 0x70BDA0
...
// Converted from cdecl void CShadows::UpdatePermanentShadows(void) 0x70C950
