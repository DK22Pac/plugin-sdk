...
public:
    ...
    static void Draw(rage::Vector4 const& rect, rage::Vector4 const& uv, rage::Color32 const& color);
...
public:
    static void DrawRect(rage::Vector4 const& rect, rage::Color32 const& col);
    static void DrawRect(rage::Vector4 const& rect, float z, rage::Color32 const& col);
