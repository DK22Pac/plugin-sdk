...
public:
	...
	uint32_t field_342;
	uint32_t field_448;
	uint8_t field_500[812]; // Sized to 812 to fill tail padding on all platforms (sizeof(CCam) remains 0x500 due to alignment)
...
VALIDATE_OFFSET(CCam, field_4, 0x4);
VALIDATE_OFFSET(CCam, m_mMatrix, 0x10);
VALIDATE_OFFSET(CCam, field_100, 0x50);
VALIDATE_OFFSET(CCam, m_fFOV, 0x60);
VALIDATE_OFFSET(CCam, m_fNearClip, 0x64);
VALIDATE_OFFSET(CCam, m_fFarClip, 0x68);
VALIDATE_OFFSET(CCam, m_fNearDOF, 0x6C);
VALIDATE_OFFSET(CCam, m_fFarDOF, 0x70);
VALIDATE_OFFSET(CCam, field_132, 0x74);
VALIDATE_OFFSET(CCam, m_pMatrix, 0x90);
VALIDATE_OFFSET(CCam, field_168, 0x94);
VALIDATE_OFFSET(CCam, m_pTheCamera, 0x114);
VALIDATE_OFFSET(CCam, m_pNext, 0x118);
VALIDATE_OFFSET(CCam, field_278, 0x11C);
VALIDATE_OFFSET(CCam, m_pCurrentCamera, 0x124);
VALIDATE_OFFSET(CCam, field_279, 0x128);
VALIDATE_OFFSET(CCam, m_bField_290, 0x13D);
VALIDATE_OFFSET(CCam, m_bField_291, 0x13E);
VALIDATE_OFFSET(CCam, m_bField_292, 0x13F);
VALIDATE_OFFSET(CCam, m_bField_293, 0x140);
VALIDATE_OFFSET(CCam, field_294, 0x141);
VALIDATE_OFFSET(CCam, m_vRot, 0x160);
VALIDATE_OFFSET(CCam, field_295, 0x170);
VALIDATE_OFFSET(CCam, field_298, 0x18D);
VALIDATE_OFFSET(CCam, m_fHintFOV, 0x1B8);
VALIDATE_OFFSET(CCam, field_300, 0x1BC);
VALIDATE_OFFSET(CCam, field_338, 0x1C8);
VALIDATE_OFFSET(CCam, field_342, 0x1CC);
VALIDATE_OFFSET(CCam, field_448, 0x1D0);
VALIDATE_OFFSET(CCam, field_500, 0x1D4);
