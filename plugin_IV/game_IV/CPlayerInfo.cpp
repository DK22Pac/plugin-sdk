...
CPlayerComponents& CPlayerInfo::ms_PlayerComponents = *gpatternt(CPlayerComponents, "88 81 ? ? ? ? C3 CC CC CC CC CC CC CC CC FF 74 24 04", 2);
bool& CPlayerInfo::ms_bDisplayingPhone = *gpatternt(bool, "80 3D ? ? ? ? ? 0F 85 ? ? ? ? 8B 0D ? ? ? ? 8B 0C 8D ? ? ? ? E8 ? ? ? ? 84 C0 0F 85", 2);
