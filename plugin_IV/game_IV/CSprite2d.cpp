...
rage::grmShader*& CSprite2d::m_imShader = *gpatternt(rage::grmShader*, "A3 ? ? ? ? 8B 01 FF 50 08 8B 0D ? ? ? ? 6A 00 6A 00 6A 00 6A 00 6A 00 6A 00 A3 ? ? ? ? 8B 01 6A 00 68 ? ? ? ? FF 50 0C 8B 3D", 1);
