...
uint8_t* CKeyboard::OldKeyState = gpatternt(uint8_t, "C6 05 ? ? ? ? ? 5E 83 C4 14", 2); // [256]
uint8_t* CKeyboard::NewKeyState = gpatternt(uint8_t, "C6 05 ? ? ? ? ? C6 05 ? ? ? ? ? 5E 83 C4 14", 2); // [256]
uint8_t* CKeyboard::TempKeyState = gpatternt(uint8_t, "C6 82 ? ? ? ? ? C6 84 11", 2); // [256]
