...
inline CVector::CVector(float x, float y, float z) {
    ((void(__thiscall*)(CVector*, float, float, float)) 0x473A6E)(this, x, y, z);
}
...
inline void CVector::operator =(const CVector& src) {
    ((void (__thiscall*)(CVector*, const CVector&)) 0x5093E0)(this, src);
}

inline void CVector::FromRwV3d(const RwV3d& src) {
    ((void (__thiscall*)(CVector*, const RwV3d&)) 0x5093E0)(this, src); // RwV3d and CVector have same memory layout
}
...
inline void CVector::FromSum(const CVector& left, const CVector& right) {
    ((void (__cdecl*)(CVector*, const CVector&, const CVector&)) 0x4739B6)(this, left, right);
}

inline void CVector::FromDiff(const CVector& left, const CVector& right) {
    ((void (__cdecl*)(CVector*, const CVector&, const CVector&)) 0x473A1C)(this, left, right);
}
...
inline void CVector::FromCross(const CVector& left, const CVector& right) {
    ((void (__cdecl*)(CVector*, const CVector&, const CVector&)) 0x4E00B0)(this, left, right);
}

inline void CVector::FromMultiply(CMatrix const& matrix, CVector const& point) {
    ((void (__cdecl*)(CVector*, const CMatrix&, const CVector&)) 0x4DFF20)(this, matrix, point);
}

inline void CVector::FromMultiply3x3(const CMatrix& matrix, const CVector& vector) {
    ((void (__cdecl*)(CVector*, const CMatrix&, const CVector&)) 0x4E0030)(this, matrix, vector);
}
...
inline float CVector::MagnitudeSqr() const {
    auto s = ((double (__fastcall*)(const CVector*)) 0x473A4F)(this);
    return (float)s;
}
...
inline void CVector::operator +=(const CVector& other) {
    ((void (__cdecl*)(CVector*, const CVector*, const CVector&)) 0x4739B6)(this, this, other);
}
...
inline void CVector::operator -=(const CVector& other) {
    ((void (__cdecl *)(CVector *, const CVector*, const CVector&)) 0x473A1C)(this, this, other);
}

inline void CVector::operator *=(float multiplier) {
    ((void (__cdecl *)(CVector *, float, const CVector*)) 0x4739E9)(this, multiplier, this);
}

inline void CVector::operator /=(float divisor) {
    ((void (__cdecl*)(CVector*, const CVector*, float divisor)) 0x599AC0)(this, this, divisor);
}
