...
using mv_addresses_t = MvAddresses<0x575190, 0x5751B0, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x575027,100,2,0,1, 0x575047,110,2,0,1>;
...
template <>
SUPPORTED_10EN_11EN inline CBulletTrace *operator_new<CBulletTrace>() {
...
template <>
SUPPORTED_10EN_11EN inline CBulletTrace *operator_new_array<CBulletTrace>(unsigned int objCount) {
