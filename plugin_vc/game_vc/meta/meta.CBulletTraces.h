...
using mv_addresses_t = MvAddresses<0x5729F0, 0x572A10, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x574798,100,0,0x574790,1, 0x5747B8,110,0,0x5747B0,1>;
using def_t = void();
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x573910, 0x573930, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x573E69,100,0,0x573D40,1, 0x573E89,110,0,0x573D60,1>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x573D40, 0x573D60, 0>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x573E80, 0x573EA0, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x62123A,100,0,0x621230,1, 0x62121A,110,0,0x621210,1>;
using def_t = void();
static const int cb_priority = PRIORITY_BEFORE; 
using calling_convention_t = CallingConventions::Cdecl;
using args_t = ArgPick<ArgTypes<>>;
