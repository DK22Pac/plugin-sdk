--! NuMake Project
inspect = workspace:load_url("https://raw.githubusercontent.com/kikito/inspect.lua/master/inspect.lua") --- For debugging purposes
