...
VALIDATE_OFFSET(CVehicle, m_nMissionValue, 0x1A2);
...
VALIDATE_OFFSET(CVehicle, field_1D0, 0x1D0);
VALIDATE_OFFSET(CVehicle, m_pCurGroundEntity, 0x1E0);
...
VALIDATE_OFFSET(CVehicle, m_nPacManPickupsCarried, 0x1FB);
...
VALIDATE_OFFSET(CVehicle, m_fMapObjectHeightAhead, 0x21C);
VALIDATE_OFFSET(CVehicle, m_fMapObjectHeightBehind, 0x220);
...
VALIDATE_OFFSET(CVehicle, m_nCarHornTimer, 0x22C);
VALIDATE_OFFSET(CVehicle, m_nCarHornPattern, 0x22D);
VALIDATE_OFFSET(CVehicle, m_bSirenOrAlarm, 0x22E);
VALIDATE_OFFSET(CVehicle, m_nCcomedyControlState, 0x22F);
