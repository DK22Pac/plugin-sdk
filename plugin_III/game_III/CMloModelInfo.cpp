...
// Converted from thiscall void CMloModelInfo::CMloModelInfo(void) 0x50C100 
CMloModelInfo::CMloModelInfo() {
    plugin::CallMethod<0x50C100, CMloModelInfo *>(this);
}

// Converted from thiscall void CMloModelInfo::~CMloModelInfo() 0x50C0E0 
CMloModelInfo::~CMloModelInfo() {
