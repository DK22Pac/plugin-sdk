...
VALIDATE_OFFSET(CAutomobile, m_carDamage, 0x288);
VALIDATE_OFFSET(CAutomobile, m_aDoors, 0x2A4);
VALIDATE_OFFSET(CAutomobile, m_aCarNodes, 0x37C);
VALIDATE_OFFSET(CAutomobile, m_aWheelColPoints, 0x3CC);
VALIDATE_OFFSET(CAutomobile, m_afSuspensionSpringRatio, 0x46C);
VALIDATE_OFFSET(CAutomobile, m_afSuspensionSpringRatioPrev, 0x47C);
VALIDATE_OFFSET(CAutomobile, m_afWheelTimer, 0x48C);
VALIDATE_OFFSET(CAutomobile, field_49C, 0x49C);
VALIDATE_OFFSET(CAutomobile, m_abWheelSkidmarkMuddy, 0x4A0);
VALIDATE_OFFSET(CAutomobile, m_abWheelSkidmarkBloody, 0x4A4);
VALIDATE_OFFSET(CAutomobile, m_afWheelRotation, 0x4A8);
VALIDATE_OFFSET(CAutomobile, m_afWheelPosition, 0x4B8);
VALIDATE_OFFSET(CAutomobile, m_afWheelSpeed, 0x4C8);
VALIDATE_OFFSET(CAutomobile, field_4D8, 0x4D8);
VALIDATE_OFFSET(CAutomobile, m_nAutomobileFlags, 0x4D9);
VALIDATE_OFFSET(CAutomobile, m_pBombRigger, 0x4DC);
VALIDATE_OFFSET(CAutomobile, field_4E0, 0x4E0);
VALIDATE_OFFSET(CAutomobile, m_nHydraulicState, 0x4E2);
VALIDATE_OFFSET(CAutomobile, m_nBusDoorTimerEnd, 0x4E4);
VALIDATE_OFFSET(CAutomobile, m_nBusDoorTimerStart, 0x4E8);
VALIDATE_OFFSET(CAutomobile, m_afSuspensionSpringLength, 0x4EC);
VALIDATE_OFFSET(CAutomobile, m_afSuspensionLineLength, 0x4FC);
VALIDATE_OFFSET(CAutomobile, m_fHeightAboveRoad, 0x50C);
VALIDATE_OFFSET(CAutomobile, m_fTraction, 0x510);
VALIDATE_OFFSET(CAutomobile, m_fVelocityChangeForAudio, 0x514);
VALIDATE_OFFSET(CAutomobile, m_randomValues, 0x518);
VALIDATE_OFFSET(CAutomobile, m_fFireBlowUpTimer, 0x530);
VALIDATE_OFFSET(CAutomobile, m_aGroundPhysical, 0x534);
VALIDATE_OFFSET(CAutomobile, m_avecGroundOffset, 0x544);
VALIDATE_OFFSET(CAutomobile, m_pSetOnFireEntity, 0x574);
VALIDATE_OFFSET(CAutomobile, m_fWeaponDoorTimerLeft, 0x578);
VALIDATE_OFFSET(CAutomobile, m_nWeaponDoorTimerRight, 0x57C);
VALIDATE_OFFSET(CAutomobile, m_fCarGunLR, 0x580);
VALIDATE_OFFSET(CAutomobile, m_fCarGunUD, 0x584);
VALIDATE_OFFSET(CAutomobile, m_fPropellerRotation, 0x588);
VALIDATE_OFFSET(CAutomobile, field_58C, 0x58C);
VALIDATE_OFFSET(CAutomobile, m_nWheelsOnGround, 0x590);
VALIDATE_OFFSET(CAutomobile, m_nDriveWheelsOnGround, 0x591);
VALIDATE_OFFSET(CAutomobile, m_nDriveWheelsOnGroundPrev, 0x592);
VALIDATE_OFFSET(CAutomobile, m_fGasPedalAudio, 0x594);
VALIDATE_OFFSET(CAutomobile, m_aWheelState, 0x598);
