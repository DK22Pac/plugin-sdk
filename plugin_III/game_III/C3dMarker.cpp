...
int addrof(C3dMarker::DeleteMarkerObject) = ADDRESS_BY_VERSION(0x51B170, 0x51B3A0, 0);
int gaddrof(C3dMarker::DeleteMarkerObject) = GLOBAL_ADDRESS_BY_VERSION(0x51B170, 0x51B3A0, 0);

void C3dMarker::DeleteMarkerObject() {
    plugin::CallMethodDynGlobal<C3dMarker *>(gaddrof(C3dMarker::DeleteMarkerObject), this);
}

int addrof(C3dMarker::Render) = ADDRESS_BY_VERSION(0x51B1B0, 0x51B3E0, 0);
int gaddrof(C3dMarker::Render) = GLOBAL_ADDRESS_BY_VERSION(0x51B1B0, 0x51B3E0, 0);

void C3dMarker::Render() {
    plugin::CallMethodDynGlobal<C3dMarker *>(gaddrof(C3dMarker::Render), this);
}

int addrof(MarkerAtomicCB) = ADDRESS_BY_VERSION(0x51B060, 0x51B290, 0);
int gaddrof(MarkerAtomicCB) = GLOBAL_ADDRESS_BY_VERSION(0x51B060, 0x51B290, 0);
