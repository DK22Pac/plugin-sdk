...
VALIDATE_OFFSET(FightMove, m_nAnimId, 0x0);
VALIDATE_OFFSET(FightMove, m_fStartFireTime, 0x4);
VALIDATE_OFFSET(FightMove, m_fEndFireTime, 0x8);
VALIDATE_OFFSET(FightMove, m_fComboFollowTime, 0xC);
VALIDATE_OFFSET(FightMove, m_fStrikeRadius, 0x10);
VALIDATE_OFFSET(FightMove, m_nHitLevel, 0x14);
VALIDATE_OFFSET(FightMove, m_nDamage, 0x15);
VALIDATE_OFFSET(FightMove, m_nFlags, 0x16);
...
VALIDATE_OFFSET(CPed, m_collPoly, 0x128);
VALIDATE_OFFSET(CPed, m_fCollisionSpeed, 0x150);
VALIDATE_OFFSET(CPed, field_15D, 0x15D);
VALIDATE_OFFSET(CPed, field_15E, 0x15E);
VALIDATE_OFFSET(CPed, field_15F, 0x15F);
VALIDATE_OFFSET(CPed, m_nCharCreatedBy, 0x160);
VALIDATE_OFFSET(CPed, m_eObjective, 0x164);
VALIDATE_OFFSET(CPed, m_ePrevObjective, 0x168);
VALIDATE_OFFSET(CPed, m_pPedInObjective, 0x16C);
VALIDATE_OFFSET(CPed, m_pCarInObjective, 0x170);
VALIDATE_OFFSET(CPed, m_vecNextRoutePointPos, 0x174);
VALIDATE_OFFSET(CPed, m_pGangLeader, 0x180);
VALIDATE_OFFSET(CPed, m_ePedFormation, 0x184);
VALIDATE_OFFSET(CPed, m_nFearFlags, 0x188);
VALIDATE_OFFSET(CPed, m_pThreatEntity, 0x18C);
VALIDATE_OFFSET(CPed, m_vec2dEventOrThreat, 0x190);
VALIDATE_OFFSET(CPed, m_nEventType, 0x198);
VALIDATE_OFFSET(CPed, m_pEventEntity, 0x19C);
VALIDATE_OFFSET(CPed, m_fAngleToEvent, 0x1A0);
VALIDATE_OFFSET(CPed, m_apFrames, 0x1A4);
VALIDATE_OFFSET(CPed, m_nAnimGroupId, 0x1D4);
VALIDATE_OFFSET(CPed, m_pVehicleAnim, 0x1D8);
VALIDATE_OFFSET(CPed, m_vec2dAnimMoveDelta, 0x1DC);
VALIDATE_OFFSET(CPed, m_vecOffsetSeek, 0x1E4);
VALIDATE_OFFSET(CPed, m_PedIK, 0x1F0);
VALIDATE_OFFSET(CPed, m_vec2dAction, 0x218);
VALIDATE_OFFSET(CPed, m_nPedStateTimer, 0x220);
VALIDATE_OFFSET(CPed, m_ePedState, 0x224);
VALIDATE_OFFSET(CPed, m_eLastPedState, 0x228);
VALIDATE_OFFSET(CPed, m_eMoveState, 0x22C);
VALIDATE_OFFSET(CPed, m_nStoredMoveState, 0x230);
VALIDATE_OFFSET(CPed, m_nPrevMoveState, 0x234);
VALIDATE_OFFSET(CPed, m_eWaitState, 0x238);
VALIDATE_OFFSET(CPed, m_nWaitTimer, 0x23C);
VALIDATE_OFFSET(CPed, m_apPathNodesStates, 0x240);
VALIDATE_OFFSET(CPed, m_aPathNodeStates, 0x260);
VALIDATE_OFFSET(CPed, m_nPathNodes, 0x2B0);
VALIDATE_OFFSET(CPed, m_nCurPathNode, 0x2B2);
VALIDATE_OFFSET(CPed, m_nPathDir, 0x2B4);
VALIDATE_OFFSET(CPed, m_pLastPathNode, 0x2B8);
VALIDATE_OFFSET(CPed, m_pNextPathNode, 0x2BC);
VALIDATE_OFFSET(CPed, m_fHealth, 0x2C0);
VALIDATE_OFFSET(CPed, m_fArmour, 0x2C4);
VALIDATE_OFFSET(CPed, m_nRouteLastPoint, 0x2C8);
VALIDATE_OFFSET(CPed, m_nRouteStartPoint, 0x2CA);
VALIDATE_OFFSET(CPed, m_nRoutePointsPassed, 0x2CC);
VALIDATE_OFFSET(CPed, m_nRouteType, 0x2CE);
VALIDATE_OFFSET(CPed, m_nRoutePointsBeingPassed, 0x2D0);
VALIDATE_OFFSET(CPed, m_vecAnimMovingShift, 0x2D4);
VALIDATE_OFFSET(CPed, m_fHeadingCurrent, 0x2DC);
VALIDATE_OFFSET(CPed, m_fHeadingGoal, 0x2E0);
VALIDATE_OFFSET(CPed, m_fHeadingChangeRate, 0x2E4);
VALIDATE_OFFSET(CPed, m_nVehicleDoor, 0x2E8);
VALIDATE_OFFSET(CPed, m_nWalkAroundType, 0x2EA);
VALIDATE_OFFSET(CPed, m_pCurrentPhysSurface, 0x2EC);
VALIDATE_OFFSET(CPed, m_vecOffsetFromPhysSurface, 0x2F0);
VALIDATE_OFFSET(CPed, m_pCurSurface, 0x2FC);
VALIDATE_OFFSET(CPed, m_vecSeekPos, 0x300);
VALIDATE_OFFSET(CPed, m_pSeekTarget, 0x30C);
VALIDATE_OFFSET(CPed, m_pVehicle, 0x310);
VALIDATE_OFFSET(CPed, m_bInVehicle, 0x314);
VALIDATE_OFFSET(CPed, m_fDistanceToCountSeekDone, 0x318);
VALIDATE_OFFSET(CPed, m_bRunningToPhone, 0x31C);
VALIDATE_OFFSET(CPed, m_nPhoneId, 0x31E);
VALIDATE_OFFSET(CPed, m_eCrimeToReportOnPhone, 0x320);
VALIDATE_OFFSET(CPed, m_nPhoneTalkTimer, 0x324);
VALIDATE_OFFSET(CPed, m_pLastAccident, 0x328);
VALIDATE_OFFSET(CPed, m_ePedType, 0x32C);
VALIDATE_OFFSET(CPed, m_pPedStats, 0x330);
VALIDATE_OFFSET(CPed, m_vec2dFleeFromPos, 0x334);
VALIDATE_OFFSET(CPed, m_pFleeFrom, 0x33C);
VALIDATE_OFFSET(CPed, m_nFleeTimer, 0x340);
VALIDATE_OFFSET(CPed, m_pCollidingEntityWhileFleeing, 0x344);
VALIDATE_OFFSET(CPed, m_nCollidingThingTimer, 0x348);
VALIDATE_OFFSET(CPed, m_pCollidingEntity, 0x34C);
VALIDATE_OFFSET(CPed, m_nStateUnused, 0x350);
VALIDATE_OFFSET(CPed, m_nTimerUnused, 0x354);
VALIDATE_OFFSET(CPed, m_pWanderRangeBounds, 0x358);
VALIDATE_OFFSET(CPed, m_aWeapons, 0x35C);
VALIDATE_OFFSET(CPed, m_eStoredWeapon, 0x494);
VALIDATE_OFFSET(CPed, m_nCurrentWeapon, 0x498);
VALIDATE_OFFSET(CPed, m_nMaxWeaponTypeAllowed, 0x499);
VALIDATE_OFFSET(CPed, m_nWeaponSkill, 0x49A);
VALIDATE_OFFSET(CPed, m_nWeaponAccuracy, 0x49B);
VALIDATE_OFFSET(CPed, m_pPointGunAt, 0x49C);
VALIDATE_OFFSET(CPed, m_vecHitLastPos, 0x4A0);
VALIDATE_OFFSET(CPed, m_nCurFightMove, 0x4AC);
VALIDATE_OFFSET(CPed, m_nFightButtonPressure, 0x4B0);
VALIDATE_OFFSET(CPed, m_nFightState, 0x4B1);
VALIDATE_OFFSET(CPed, m_bTakeAStepAfterAttack, 0x4B2);
VALIDATE_OFFSET(CPed, m_pFire, 0x4B4);
VALIDATE_OFFSET(CPed, m_pLookTarget, 0x4B8);
VALIDATE_OFFSET(CPed, m_fLookDirection, 0x4BC);
VALIDATE_OFFSET(CPed, m_nWepModelID, 0x4C0);
VALIDATE_OFFSET(CPed, m_nLeaveCarTimer, 0x4C4);
VALIDATE_OFFSET(CPed, m_nGetUpTimer, 0x4C8);
VALIDATE_OFFSET(CPed, m_nLookTimer, 0x4CC);
VALIDATE_OFFSET(CPed, m_nChatTimer, 0x4D0);
VALIDATE_OFFSET(CPed, m_nAttackTimer, 0x4D4);
VALIDATE_OFFSET(CPed, m_nShootTimer, 0x4D8);
VALIDATE_OFFSET(CPed, m_nCarJackTimer, 0x4DC);
VALIDATE_OFFSET(CPed, m_nObjectiveTimer, 0x4E0);
VALIDATE_OFFSET(CPed, m_nDuckTimer, 0x4E4);
VALIDATE_OFFSET(CPed, m_nDuckAndCoverTimer, 0x4E8);
VALIDATE_OFFSET(CPed, m_nBloodyFootprintCountOrDeathTime, 0x4EC);
VALIDATE_OFFSET(CPed, m_nPanicCounter, 0x4F0);
VALIDATE_OFFSET(CPed, m_bDeadBleeding, 0x4F1);
VALIDATE_OFFSET(CPed, m_nBodyPartBleeding, 0x4F2);
VALIDATE_OFFSET(CPed, m_apNearPeds, 0x4F4);
VALIDATE_OFFSET(CPed, m_nNumNearPeds, 0x51C);
VALIDATE_OFFSET(CPed, m_nLastWepDam, 0x51E);
VALIDATE_OFFSET(CPed, m_nLastSoundStart, 0x520);
VALIDATE_OFFSET(CPed, m_nSoundStart, 0x524);
VALIDATE_OFFSET(CPed, m_nLastQueuedSound, 0x528);
VALIDATE_OFFSET(CPed, m_nQueuedSound, 0x52A);
VALIDATE_OFFSET(CPed, m_vecSeekPosEx, 0x52C);
VALIDATE_OFFSET(CPed, m_fDistanceToCountSeekDoneEx, 0x538);
