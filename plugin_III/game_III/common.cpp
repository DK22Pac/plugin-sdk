...
// Converted from cdecl AnimBlendFrameData* RpAnimBlendClumpFindFrame(RpClump *clump, char const *name) 0x405430
...
// Converted from cdecl void RpAnimBlendClumpInit(RpClump *clump) 0x405480
void RpAnimBlendClumpInit(RpClump* clump) {
    plugin::Call<0x405480, RpClump*>(clump);
}

// Converted from cdecl bool RpAnimBlendClumpIsInitialized(RpClump *clump) 0x405500
