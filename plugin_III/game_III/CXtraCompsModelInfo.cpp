...
// Converted from thiscall void CXtraCompsModelInfo::CXtraCompsModelInfo(void) 0x50BF10
CXtraCompsModelInfo::CXtraCompsModelInfo() {
    plugin::CallMethod<0x50BF10, CXtraCompsModelInfo *>(this);
}

// Converted from thiscall void CXtraCompsModelInfo::~CXtraCompsModelInfo() 0x50BEF0
CXtraCompsModelInfo::~CXtraCompsModelInfo() {
