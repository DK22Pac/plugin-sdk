...
using mv_addresses_t = MvAddresses<0x42F5D0, 0x42F5D0, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x43020F,100,0,0x430200,1, 0x43020F,110,0,0x430200,1>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x42F600, 0x42F600, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x43020B,100,2,0,1, 0x43020B,110,2,0,1>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x42F640, 0x42F640, 0>;
// total references count: 10en (2), 11en (2), steam (0)
using refs_t = RefList<0x48C24D,100,0,0x48BED0,1, 0x48C570,100,0,0x48C4B0,1, 0x48C33D,110,0,0x48BFC0,1, 0x48C670,110,0,0x48C5B0,1>;
using def_t = void(CPhoneInfo *);
static const int cb_priority = PRIORITY_BEFORE; 
using calling_convention_t = CallingConventions::Thiscall;
using args_t = ArgPick<ArgTypes<CPhoneInfo *>, 0>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x42F710, 0x42F710, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x48C3C7,100,0,0x48C3A0,1, 0x48C4B7,110,0,0x48C490,1>;
using def_t = void(CPhoneInfo *);
static const int cb_priority = PRIORITY_BEFORE; 
using calling_convention_t = CallingConventions::Thiscall;
using args_t = ArgPick<ArgTypes<CPhoneInfo *>, 0>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x42F720, 0x42F720, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x4C10F6,100,0,0x4C10C0,1, 0x4C11E6,110,0,0x4C11B0,1>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x42F7A0, 0x42F7A0, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x48C9EB,100,0,0x48C850,1, 0x48CAEB,110,0,0x48C950,1>;
using def_t = void(CPhoneInfo *);
static const int cb_priority = PRIORITY_BEFORE; 
using calling_convention_t = CallingConventions::Thiscall;
using args_t = ArgPick<ArgTypes<CPhoneInfo *>, 0>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x42FD50, 0x42FD50, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x4D0510,100,0,0x4D0490,1, 0x4D05B0,110,0,0x4D0530,1>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x42FDB0, 0x42FDB0, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x444684,100,0,0x4429C0,1, 0x444684,110,0,0x4429C0,1>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x42FF30, 0x42FF30, 0>;
// total references count: 10en (6), 11en (6), steam (0)
using refs_t = RefList<0x4446FD,100,0,0x4429C0,1, 0x44C39A,100,0,0x448240,1, 0x44C54C,100,0,0x448240,2, 0x44C772,100,0,0x448240,3, 0x44CD5E,100,0,0x44CB80,1, 0x44D03F,100,0,0x44CB80,2, 0x4446FD,110,0,0x4429C0,1, 0x44C39A,110,0,0x448240,1, 0x44C54C,110,0,0x448240,2, 0x44C772,110,0,0x448240,3, 0x44CD5E,110,0,0x44CB80,1, 0x44D03F,110,0,0x44CB80,2>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x42FF90, 0x42FF90, 0>;
// total references count: 10en (7), 11en (7), steam (0)
using refs_t = RefList<0x444764,100,0,0x4429C0,1, 0x4447D6,100,0,0x4429C0,2, 0x44C456,100,0,0x448240,1, 0x44C642,100,0,0x448240,2, 0x44C8A2,100,0,0x448240,3, 0x44CEB1,100,0,0x44CB80,1, 0x44D1C8,100,0,0x44CB80,2, 0x444764,110,0,0x4429C0,1, 0x4447D6,110,0,0x4429C0,2, 0x44C456,110,0,0x448240,1, 0x44C642,110,0,0x448240,2, 0x44C8A2,110,0,0x448240,3, 0x44CEB1,110,0,0x44CB80,1, 0x44D1C8,110,0,0x44CB80,2>;
using def_t = void(CPhoneInfo *, int, wchar_t *, wchar_t *, wchar_t *, wchar_t *, wchar_t *, wchar_t *);
static const int cb_priority = PRIORITY_BEFORE; 
using calling_convention_t = CallingConventions::Thiscall;
using args_t = ArgPick<ArgTypes<CPhoneInfo *,int,wchar_t *,wchar_t *,wchar_t *,wchar_t *,wchar_t *,wchar_t *>, 0,1,2,3,4,5,6,7>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x42FFF0, 0x42FFF0, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x444791,100,0,0x4429C0,1, 0x444791,110,0,0x4429C0,1>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x430030, 0x430030, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x44EBD1,100,0,0x44CB80,1, 0x44EBD1,110,0,0x44CB80,1>;
using def_t = bool(CPhoneInfo *, int);
static const int cb_priority = PRIORITY_BEFORE; 
using calling_convention_t = CallingConventions::Thiscall;
using args_t = ArgPick<ArgTypes<CPhoneInfo *,int>, 0,1>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x430060, 0x430060, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x59012D,100,0,0x58F8D0,1, 0x59041D,110,0,0x58FBC0,1>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x430120, 0x430120, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x59124A,100,0,0x590A00,1, 0x59150A,110,0,0x590CC0,1>;
using def_t = void(CPhoneInfo *, unsigned char *, unsigned int);
static const int cb_priority = PRIORITY_BEFORE; 
using calling_convention_t = CallingConventions::Thiscall;
using args_t = ArgPick<ArgTypes<CPhoneInfo *,unsigned char *,unsigned int>, 0,1,2>;
...
template <>
SUPPORTED_10EN_11EN inline CPhoneInfo *operator_new<CPhoneInfo>() {
...
template <>
SUPPORTED_10EN_11EN inline CPhoneInfo *operator_new_array<CPhoneInfo>(unsigned int objCount) {
