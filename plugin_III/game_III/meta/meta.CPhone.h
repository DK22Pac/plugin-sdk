...
using mv_addresses_t = MvAddresses<0x42F620, 0x42F620, 0>;
// total references count: 10en (2), 11en (2), steam (0)
using refs_t = RefList<0x42FDC0,100,0,0x42FDB0,1, 0x42F5E0,100,2,0,1, 0x42FDC0,110,0,0x42FDB0,1, 0x42F5E0,110,2,0,1>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x42F630, 0x42F630, 0>;
// total references count: 10en (3), 11en (3), steam (0)
using refs_t = RefList<0x42FF13,100,0,0x42FDB0,1, 0x42F5DB,100,2,0,1, 0x42F60B,100,2,0,1, 0x42FF13,110,0,0x42FDB0,1, 0x42F5DB,110,2,0,1, 0x42F60B,110,2,0,1>;
