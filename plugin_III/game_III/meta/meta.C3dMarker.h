...
using mv_addresses_t = MvAddresses<0x51B070, 0x51B2A0, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x51B95B,100,0,0x51B480,1, 0x51BB8B,110,0,0x51B6B0,1>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x51B170, 0x51B3A0, 0>;
// total references count: 10en (3), 11en (3), steam (0)
using refs_t = RefList<0x51B3CB,100,0,0x51B3B0,1, 0x51B460,100,0,0x51B400,1, 0x51B925,100,0,0x51B480,1, 0x51B5FB,110,0,0x51B5E0,1, 0x51B690,110,0,0x51B630,1, 0x51BB55,110,0,0x51B6B0,1>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x51B1B0, 0x51B3E0, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x51B441,100,0,0x51B400,1, 0x51B671,110,0,0x51B630,1>;
using def_t = void(C3dMarker *);
static const int cb_priority = PRIORITY_BEFORE; 
using calling_convention_t = CallingConventions::Thiscall;
using args_t = ArgPick<ArgTypes<C3dMarker *>, 0>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x51C320, 0x51C550, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x51C29A,100,2,0,1, 0x51C4CA,110,2,0,1>;
...
static const bool is_virtual = false;
static const int vtable_index = -1;
using mv_addresses_t = MvAddresses<0x51B060, 0x51B290, 0>;
// total references count: 10en (1), 11en (1), steam (0)
using refs_t = RefList<0x51B0A1,100,2,0,1, 0x51B2D1,110,2,0,1>;
...
template <>
SUPPORTED_10EN_11EN inline C3dMarker *operator_new<C3dMarker>() {
...
template <>
SUPPORTED_10EN_11EN inline C3dMarker *operator_new_array<C3dMarker>(unsigned int objCount) {
